		...
		_axios["default"]
			...
			.then(function(res) {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "FETCHING_QUIZZES_FAIL")
					);
				}
			});
	};
		...
		return _axios["default"]
			...
			.then(function() {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "CONTACT_UPLOAD_FAIL")
					);
				}
			});
	};
		...
		return _axios["default"]
			...
			.then(function() {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "DELETE_CONTACT_FAIL")
					);
				}
			});
	};
		...
		return _axios["default"]
			...
			.then(function() {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "DELETE_GROUP_FAIL")
					);
				}
			});
	};
		...
		return _axios["default"]
			...
			.then(function() {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "UDPDATE_CONTACT_FAIL")
					);
				}
			});
	};
		...
		return _axios["default"]
			...
			.then(function() {
				...
				if (!err.response) {
					...
					dispatch(
						(0, _errorActions.returnErrors)(err.response.data, err.response.status, "UPDATE_GROUP_FAIL")
					);
				}
			});
	};
