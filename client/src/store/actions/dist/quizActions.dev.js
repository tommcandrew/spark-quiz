          ...
          case 0:
            ...
            return _context.abrupt("return", _axios["default"].post("https://sparkquiz-backend.herokuapp.com/quiz/createQuiz", {
              ...
              if (!err.response) {
                ...
                dispatch((0, _errorActions.returnErrors)(err.response.data, err.response.status, "CREATE_QUIZ_FAIL"));
              }
            }));
  ...
  return function (dispatch, getState) {
    ...
    return _axios["default"].post("https://sparkquiz-backend.herokuapp.com/quiz/publishQuiz", {
      ...
      if (!err.response) {
        ...
        dispatch((0, _errorActions.returnErrors)(err.response.data, err.response.status, "QUIZ_PUBLISH_FAIL"));
      }
    });
  };
};
