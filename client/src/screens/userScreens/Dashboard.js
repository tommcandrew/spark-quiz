...
import { AppBar, CssBaseline, Drawer, Hidden, IconButton, Toolbar, Button, Typography, Paper } from "@material-ui/core";
				...
				<nav className={classes.drawer} aria-label="mailbox folders">
					<Hidden smUp implementation="css">
						<Drawer
							...
							<CustomDrawer url={url} clearQuizState={clearQuizState} />
						</Drawer>
					</Hidden>
