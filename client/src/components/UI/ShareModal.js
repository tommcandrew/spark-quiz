...
const ShareModal = ({ quizId, closeModal }) => {
	...
	const handleaddGroup = (e) => {
		...
		if (e.target.checked) {
			...
			setRecipientsGroups(recipientsGroups.filter((recipient) => recipient._id !== selectedGroupId));
		}
	};
	...
	const handleAddContact = (e) => {
		...
		if (e.target.checked) {
			...
			setRecipientsContacts(recipientsContacts.filter((recipient) => recipient._id !== selectedContactId));
		}
	};
